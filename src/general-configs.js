...
export const likePath = "/like/";//id represent the id of the comment getting de action
export const dislikePath = "/dislike/";//id represent the id of the comment getting de action
