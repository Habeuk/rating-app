import { inject as Yt, watch as lt, reactive as Qt, ref as M, createVNode as T, h as ge, computed as R, openBlock as b, createElementBlock as y, normalizeStyle as Ve, createElementVNode as h, normalizeClass as Z, resolveComponent as Ae, toDisplayString as A, Fragment as H, renderList as G, createBlock as Te, createCommentVNode as I, Transition as Zt, withCtx as en, createStaticVNode as ut, pushScopeId as dt, popScopeId as ft, unref as ve, mergeProps as $e, createApp as tn } from "vue";
function nn() {
...
var bn = "vuex bindings", Ke = "vuex:mutations", be = "vuex:actions", B = "vuex", yn = 0;
function Sn(e, t) {
  un(
    {
      id: "org.vuejs.vuex",
...
var qe = 8702998, wn = 6710886, En = 16777215, vt = {
  label: "namespaced",
  textColor: En,
  backgroundColor: wn
};
...
function Nn(e) {
  ...
  return c === void 0 && (c = console), function(l) {
    ...
    typeof c > "u" || (a && l.subscribe(function(_, g) {
      var m = Ce(g);
      if (r(_, f, m)) {
        var p = Xe(), E = s(_), w = "mutation " + _.type + p;
      ...
      if (o(_, g)) {
        var m = Xe(), p = i(_), E = "action " + _.type + m;
...
const Fn = fe("string"), x = fe("function"), Nt = fe("number"), me = (e) => e !== null && typeof e == "object", Un = (e) => e === !0 || e === !1, ee = (e) => {
  if (de(e) !== "object")
    return !1;
  const t = Ue(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, jn = P("Date"), Bn = P("File"), Hn = P("Blob"), Gn = P("FileList"), zn = (e) => me(e) && x(e.pipe), Vn = (e) => {
  let t;
...
), Ye = (({ hasOwnProperty: e }) => (t, r) => e.call(t, r))(Object.prototype), sr = P("RegExp"), Lt = (e, t) => {
...
}, cr = (e, t) => (e = +e, Number.isFinite(e) ? e : t), ye = "abcdefghijklmnopqrstuvwxyz", Qe = "0123456789", It = {
  DIGIT: Qe,
  ALPHA: ye,
  ALPHA_DIGIT: ye + ye.toUpperCase() + Qe
}, lr = (e = 16, t = It.ALPHA_DIGIT) => {
  let r = "";
  const { length: n } = t;
  for (; e--; )
    r += t[Math.random() * n | 0];
...
const dr = (e) => {
  ...
  return r(e, 0);
}, fr = P("AsyncFunction"), mr = (e) => e && (me(e) || x(e)) && x(e.then) && x(e.catch), d = {
  isArray: $,
  isArrayBuffer: Rt,
  isBuffer: In,
  isFormData: Vn,
...
function he(e, t, r) {
  ...
  function l(m, p, E) {
    ...
    if (m && !E && typeof m == "object") {
      ...
      else if (d.isArray(m) && pr(m) || (d.isFileList(m) || d.endsWith(p, "[]")) && (w = d.toArray(m)))
        return p = Ut(p), w.forEach(function(Y, Xt) {
...
}, br = typeof URLSearchParams < "u" ? URLSearchParams : je, yr = typeof FormData < "u" ? FormData : null, Sr = typeof Blob < "u" ? Blob : null, wr = (() => {
  let e;
...
const Gr = typeof XMLHttpRequest < "u", zr = Gr && function(e) {
...
S.HttpStatusCode = Wr;
S.default = S;
const Xr = S, at = window.location.host, Yr = at.includes("localhost") || at.includes("kksa") ? "http://my-nutribe.kksa/" : "http://my.nutribe.fr/", Qr = "/shopify/get-reviews.php?", Zr = "/shopify/like-review.php?id=", es = "/shopify/dislike-review.php?id=", ct = "&reset=1", qt = "app", ts = "data-product-handler", ns = {
  currentPage: 1,
  commentsPerPages: 10,
  indexPrinted: 5
}, Oe = Xr.create({
...
function hs(e, t, r, n, s, o) {
  ...
  return b(), y("div", as, [
    ...
    h("div", us, [
      ...
      h("div", fs, [
        (b(), y(H, null, G(5, (u) => h("span", {
          class: "resume-count",
          key: 6 - u
        }, "(" + A(r.ratesCounts[5 - u]) + ")", 1)), 64))
      ]),
      h("div", ms, [
        (b(), y(H, null, G(5, (u) => h("div", {
          key: 6 - u,
...
`) + a
...
}, U = (e) => (dt("data-v-fb9a252f"), e = e(), ft(), e), gs = { class: "single-comment" }, vs = { class: "comment-header" }, bs = { class: "user-profil-icon" }, ys = { class: "user-profil-letter" }, Ss = {
  key: 0,
  class: "verified-icon"
  ...
  ws
], Os = { class: "header-elements" }, As = { class: "user-profil-name" }, Ts = { class: "user-verified-state" }, xs = /* @__PURE__ */ U(() => /* @__PURE__ */ h("div", { class: "clear-fix" }, null, -1)), Cs = { class: "comments-rate" }, Rs = { class: "comment-main" }, Ns = {
  key: 0,
  class: "comment-title"
}, Ps = ["innerHTML"], ks = { class: "comment-footer" }, Ds = { class: "footer-action" }, Ls = { class: "primary-action" }, Is = /* @__PURE__ */ ut('<span class="share-icon" data-v-fb9a252f><svg width="800" height="800" viewBox="0 0 24 24" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" class="icon flat-line" data-v-fb9a252f><path d="m16 3 5 4-5 4V9s-5 0-7 3c0 0 1-6 7-7Z" style="stroke-width:2;" data-v-fb9a252f></path><path d="m16 3 5 4-5 4V9s-5 0-7 3c0 0 1-6 7-7Z" style="fill:currentColor;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:2;" data-v-fb9a252f></path><path data-name="primary" d="M21 13v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h4" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:2;" data-v-fb9a252f></path></svg></span>', 1), Ms = { class: "share-label" }, Fs = {
  key: 0,
  class: "media-links"
}, Us = /* @__PURE__ */ U(() => /* @__PURE__ */ h("span", { class: "separator" }, null, -1)), js = { class: "share-options-wrapper" }, Bs = { class: "y-label yotpo-action" }, Hs = ["onClick"], Gs = {
  key: 0,
  class: "action-separator"
}, zs = /* @__PURE__ */ U(() => /* @__PURE__ */ h("span", { class: "separator" }, null, -1)), Vs = { class: "reaction" }, $s = { class: "comment-date" }, Ks = {
  class: "comment-vote",
  role: "group"
  ...
  key: 0,
  class: "admin-reply"
}, eo = { class: "content" }, to = /* @__PURE__ */ ut('<div class="comment-header" data-v-fb9a252f><span class="user-profil-icon" data-v-fb9a252f><div data-v-fb9a252f><img class="yotpo-store-avatar" src="//cdn-yotpo-images-production.yotpo.com/App/323944/61533541/thumb.png?1540639645" alt="" data-v-fb9a252f></div><span class="verified-icon" data-v-fb9a252f><svg fill="currentColor" width="800" height="800" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" data-v-fb9a252f><path d="M16 3C8.82 3 3 8.82 3 16s5.82 13 13 13 13-5.82 13-13S23.18 3 16 3zm7.258 9.307-9.486 9.485a.61.61 0 0 1-.861 0l-.191-.191-.001.001L7.5 16.346a.61.61 0 0 1 0-.862l1.294-1.293a.61.61 0 0 1 .862 0l3.689 3.716 7.756-7.756a.61.61 0 0 1 .862 0l1.294 1.294a.609.609 0 0 1 .001.862z" data-v-fb9a252f></path></svg></span></span></div>', 1), no = /* @__PURE__ */ U(() => /* @__PURE__ */ h("div", null, null, -1)), ro = { class: "comment-main reply-content" };
function so(e, t, r, n, s, o) {
  const i = Ae("StarsRate");
  return b(), y("div", gs, [
    h("div", vs, [
      h("span", bs, [
        h("span", ys, A(n.icon.toUpperCase()), 1),
        r.state ? (b(), y("span", Ss, Es)) : I("", !0)
      ]),
      h("div", Os, [
    ...
    h("div", Rs, [
      r.title ? (b(), y("div", Ns, A(r.title), 1)) : I("", !0),
      h("div", {
    ...
    h("div", ks, [
      h("div", Ds, [
        h("div", Ls, [
          ...
          T(Zt, null, {
            default: en(() => [
              n.showMediaLink ? (b(), y("span", Fs, [
                Us,
                h("span", js, [
                  (b(!0), y(H, null, G(n.shareLinks.length, (a) => (b(), y("span", {
                    class: "list-item",
                    key: a
                  }, [
                    h("span", Bs, [
                      ...
                      a != n.shareLinks.length ? (b(), y("span", Gs)) : I("", !0)
                    ])
                  ]))), 128))
                ]),
                zs
...
const oo = /* @__PURE__ */ X(_s, [["render", so], ["__scopeId", "data-v-fb9a252f"]]), io = {
  props: {
    currentPage: Number,
  ...
  setup(e, {
    ...
    const r = ie(), n = Math.ceil(r.state.commentsNumber / e.commentsPerPages), s = M(e.indexPrinted % 2 ? e.indexPrinted - 1 : e.indexPrinted), o = R(() => e.currentPage), i = R(() => {
      let c = 1, l = 0;
...
function po(e, t, r, n, s, o) {
  return b(), y("nav", ao, [
    h("div", co, [
      ...
      (b(!0), y(H, null, G(n.getIndexes.count, (i) => (b(), y("a", {
        key: i,
...
const _o = /* @__PURE__ */ X(io, [["render", po]]), go = (e) => (dt("data-v-9fe6d11c"), e = e(), ft(), e), vo = {
  ...
  setup(e) {
    ...
    return (l, f) => (b(), y("div", vo, [T(ps, {
      onApplyFilter: i,
      "rates-counts": ve(t).state.summary,
      "rate-selected": ve(t).state.rateSelected
    }, null, 8, ["rates-counts", "rate-selected"]), bo, ve(t).state.rateSelected ? (b(), y("div", {
      key: 0,
      onClick: f[0] || (f[0] = (_) => i(0)),
      class: "reset-comments"
    }, "Voir tous les avis")) : I("", !0), h("div", yo, [h("span", null, A(r.value), 1)]), h("div", So, [(b(!0), y(H, null, G(s.value, (_) => (b(), Te(oo, $e({
      onLikeAction: u,
      onDislikeAction: c
    }, _, {
      key: _.id
...
const Eo = /* @__PURE__ */ X(wo, [["__scopeId", "data-v-9fe6d11c"]]), Oo = document.getElementById(qt), Ao = Oo.getAttribute(ts);
