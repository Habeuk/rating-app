import { inject as Yt, watch as lt, reactive as Zt, ref as I, createVNode as T, h as _e, computed as C, openBlock as b, createElementBlock as w, normalizeStyle as Ve, createElementVNode as h, normalizeClass as Z, resolveComponent as Ae, toDisplayString as A, Fragment as H, renderList as z, createBlock as Te, createCommentVNode as B, Transition as en, withCtx as tn, createStaticVNode as ut, pushScopeId as dt, popScopeId as ft, unref as ve, mergeProps as $e, createApp as nn } from "vue";
function rn() {
...
function cn() {
  var e;
  return U !== void 0 || (typeof window < "u" && window.performance ? (U = !0, xe = window.performance) : typeof global < "u" && (!((e = global.perf_hooks) === null || e === void 0) && e.performance) ? (U = !0, xe = global.perf_hooks.performance) : U = !1), U;
}
function ln() {
...
var yn = "vuex bindings", qe = "vuex:mutations", be = "vuex:actions", j = "vuex", wn = 0;
function Sn(e, t) {
  dn(
    {
      id: "org.vuejs.vuex",
    ...
    function(r) {
      r.addTimelineLayer({
        ...
        if (n.app === e && n.inspectorId === j)
          if (n.filter) {
            var s = [];
            wt(s, t._modules.root, n.filter, ""), n.rootNodes = s;
          } else
            n.rootNodes = [
              yt(t._modules.root, "")
            ];
        ...
        before: function(n, s) {
          var o = {};
          n.payload && (o.payload = n.payload), n._id = wn++, n._time = Date.now(), o.state = s, r.addTimelineEvent({
            layerId: be,
            event: {
              time: n._time,
              title: n.type,
...
var Ke = 8702998, En = 6710886, On = 16777215, vt = {
  label: "namespaced",
  textColor: On,
  backgroundColor: En
};
...
function Pn(e) {
  ...
  return c === void 0 && (c = console), function(l) {
    ...
    typeof c > "u" || (a && l.subscribe(function(g, _) {
      var m = Ne(_);
      if (r(g, f, m)) {
        var p = Xe(), E = s(g), S = "mutation " + g.type + p;
        Je(c, S, t), c.log("%c prev state", "color: #9E9E9E; font-weight: bold", n(f)), c.log("%c mutation", "color: #03A9F4; font-weight: bold", E), c.log("%c next state", "color: #4CAF50; font-weight: bold", n(m)), We(c);
      }
      f = m;
...
const Un = fe("string"), x = fe("function"), Rt = fe("number"), me = (e) => e !== null && typeof e == "object", jn = (e) => e === !0 || e === !1, ee = (e) => {
  if (de(e) !== "object")
    return !1;
  const t = Ue(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, Bn = P("Date"), Hn = P("File"), zn = P("Blob"), Gn = P("FileList"), Vn = (e) => me(e) && x(e.pipe), $n = (e) => {
  let t;
  return e && (typeof FormData == "function" && e instanceof FormData || x(e.append) && ((t = de(e)) === "formdata" || // detect form-data instance
  t === "object" && x(e.toString) && e.toString() === "[object FormData]"));
}, qn = P("URLSearchParams"), Kn = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const kt = (() => typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global)(), Dt = (e) => !K(e) && e !== kt;
function Re() {
...
const Jn = (e, t, r, { allOwnKeys: n } = {}) => (J(t, (s, o) => {
  ...
  for (; t-- > 0; )
    r[t] = e[t];
  return r;
}, er = ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Ue(Uint8Array)), tr = (e, t) => {
...
), Qe = (({ hasOwnProperty: e }) => (t, r) => e.call(t, r))(Object.prototype), or = P("RegExp"), Lt = (e, t) => {
...
}, lr = (e, t) => (e = +e, Number.isFinite(e) ? e : t), ye = "abcdefghijklmnopqrstuvwxyz", Ye = "0123456789", It = {
  DIGIT: Ye,
  ALPHA: ye,
...
const fr = (e) => {
  ...
  return r(e, 0);
}, mr = P("AsyncFunction"), hr = (e) => e && (me(e) || x(e)) && x(e.then) && x(e.catch), d = {
  isArray: $,
  isArrayBuffer: Ct,
  isBuffer: Mn,
  isFormData: $n,
...
function he(e, t, r) {
  ...
  function l(m, p, E) {
    ...
    if (m && !E && typeof m == "object") {
      ...
      else if (d.isArray(m) && gr(m) || (d.isFileList(m) || d.endsWith(p, "[]")) && (S = d.toArray(m)))
        return p = Ut(p), S.forEach(function(Q, Qt) {
          !(d.isUndefined(Q) || Q === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? Ze([p], Qt, o) : i === null ? p : p + "[]",
            c(Q)
          );
        }), !1;
    }
  ...
  function _(m, p) {
    if (!d.isUndefined(m)) {
      ...
      f.push(m), d.forEach(m, function(S, D) {
...
}, yr = typeof URLSearchParams < "u" ? URLSearchParams : je, wr = typeof FormData < "u" ? FormData : null, Sr = typeof Blob < "u" ? Blob : null, Er = (() => {
  let e;
...
const pe = {
  ...
  transformRequest: [function(t, r) {
    ...
    if (o && d.isHTMLForm(t) && (t = new FormData(t)), d.isFormData(t))
      return s && s ? JSON.stringify(zt(t)) : t;
...
d.forEach(["post", "put", "patch"], function(t) {
  pe.headers[t] = d.merge(Nr);
});
const Be = pe, Rr = d.toObjectSet([
  "age",
  "authorization",
  "content-length",
  "content-type",
  ...
  return e && e.split(`
`).forEach(function(i) {
    s = i.indexOf(":"), r = i.substring(0, s).trim().toLowerCase(), n = i.substring(s + 1).trim(), !(!r || t[r] && Rr[r]) && (r === "set-cookie" ? t[r] ? t[r].push(n) : t[r] = [n] : t[r] = t[r] ? t[r] + ", " + n : n);
  }), t;
}, nt = Symbol("internals");
function q(e) {
  ...
  delete(t, r) {
    ...
    function o(i) {
      if (i = q(i), i) {
        ...
        a && (!r || we(n, n[a], a, r)) && (delete n[a], s = !0);
      }
    }
...
const Fr = R.isStandardBrowserEnv ? (
...
const Br = R.isStandardBrowserEnv ? (
...
const Gr = typeof XMLHttpRequest < "u", Vr = Gr && function(e) {
...
function st(e) {
  return Ee(e), e.headers = k.from(e.headers), e.data = Se.call(
    e,
    e.transformRequest
    ...
    return Ee(e), n.data = Se.call(
      e,
      e.transformResponse,
      n
    ), n.headers = k.from(n.headers), n;
  }, function(n) {
    return Gt(n) || (Ee(e), n && n.response && (n.response.data = Se.call(
      e,
      e.transformResponse,
      n.response
...
y.mergeConfig = G;
y.AxiosHeaders = k;
y.formToJSON = (e) => zt(d.isHTMLForm(e) ? new FormData(e) : e);
y.HttpStatusCode = Xr;
y.default = y;
const Qr = y, at = window.location.host, Yr = at.includes("localhost") || at.includes("kksa") ? "http://my-nutribe.kksa/" : "http://my.nutribe.fr/", Zr = "/shopify/get-reviews.php?", es = "/shopify/like-review.php?id=", ts = "/shopify/dislike-review.php?id=", ct = "&reset=1", Kt = "app", ns = "data-product-handler", rs = {
  currentPage: 1,
  commentsPerPages: 10,
  indexPrinted: 5
}, Oe = Qr.create({
  ...
  return b(), w("div", cs, [
    h("div", ls, [
      h("span", null, [
        ...
        h("span", us, A(n.calcSum + " Avis"), 1)
      ])
    ]),
    h("div", ds, [
      h("div", fs, [
        (b(), w(H, null, z(5, (u) => T(i, {
          key: 6 - u,
          percentage: 20 * (6 - u),
          class: "stars-set"
      ...
      h("div", ms, [
        (b(), w(H, null, z(5, (u) => h("span", {
          class: "resume-count",
          key: 6 - u
        }, "(" + A(r.ratesCounts[5 - u]) + ")", 1)), 64))
      ]),
      h("div", hs, [
        (b(), w(H, null, z(5, (u) => h("div", {
          key: 6 - u,
...
const gs = /* @__PURE__ */ X(as, [["render", ps]]);
const _s = {
  props: {
    id: Number,
    name: String,
...
`) + a
    ...
    let f = (m) => (window.open(m, "popup", "width=600,height=600"), !1), g = (m) => {
      const p = new Date(m * 1e3), E = p.getDate() < 10 ? "0" + p.getDate() : p.getDate(), S = p.getMonth() + 1, D = S < 10 ? "0" + S : S;
...
}, F = (e) => (dt("data-v-437fdb74"), e = e(), ft(), e), vs = { class: "single-comment" }, bs = { class: "comment-header" }, ys = { class: "user-profil-icon" }, ws = { class: "user-profil-letter" }, Ss = {
  key: 0,
  class: "verified-icon"
}, Es = /* @__PURE__ */ F(() => /* @__PURE__ */ h("svg", {
  fill: "currentColor",
  width: "800",
  height: "800",
  viewBox: "0 0 32 32",
  ...
  Es
], As = { class: "header-elements" }, Ts = { class: "user-profil-name" }, xs = { class: "user-verified-state" }, Ns = /* @__PURE__ */ F(() => /* @__PURE__ */ h("div", { class: "clear-fix" }, null, -1)), Cs = { class: "comments-rate" }, Rs = { class: "comment-main" }, Ps = { class: "comment-title" }, ks = ["innerHTML"], Ds = { class: "comment-footer" }, Ls = { class: "footer-action" }, Is = { class: "primary-action" }, Ms = /* @__PURE__ */ ut('<span class="share-icon" data-v-437fdb74><svg width="800" height="800" viewBox="0 0 24 24" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" class="icon flat-line" data-v-437fdb74><path d="m16 3 5 4-5 4V9s-5 0-7 3c0 0 1-6 7-7Z" style="stroke-width:2;" data-v-437fdb74></path><path d="m16 3 5 4-5 4V9s-5 0-7 3c0 0 1-6 7-7Z" style="fill:currentColor;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:2;" data-v-437fdb74></path><path data-name="primary" d="M21 13v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h4" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:2;" data-v-437fdb74></path></svg></span>', 1), Fs = { class: "share-label" }, Us = {
  key: 0,
  class: "media-links"
}, js = /* @__PURE__ */ F(() => /* @__PURE__ */ h("span", { class: "separator" }, null, -1)), Bs = { class: "share-options-wrapper" }, Hs = { class: "y-label yotpo-action" }, zs = ["onClick"], Gs = {
  key: 0,
  class: "action-separator"
}, Vs = /* @__PURE__ */ F(() => /* @__PURE__ */ h("span", { class: "separator" }, null, -1)), $s = { class: "reaction" }, qs = { class: "comment-date" }, Ks = {
  class: "comment-vote",
  role: "group"
}, Js = /* @__PURE__ */ F(() => /* @__PURE__ */ h("span", { class: "up-vote-icon vote-icon" }, [
  /* @__PURE__ */ h("svg", {
    fill: "currentColor",
    width: "800",
    height: "800",
  ...
  Js
], Xs = { class: "up-vote-sum vote-count" }, Qs = /* @__PURE__ */ F(() => /* @__PURE__ */ h("span", { class: "down-vote-icon vote-icon" }, [
  /* @__PURE__ */ h("svg", {
    width: "800",
    height: "800",
    viewBox: "0 0 24 24",
  ...
  key: 0,
  class: "admin-reply"
}, to = { class: "content" }, no = /* @__PURE__ */ ut('<div class="comment-header" data-v-437fdb74><span class="user-profil-icon" data-v-437fdb74><div data-v-437fdb74><img class="yotpo-store-avatar" src="//cdn-yotpo-images-production.yotpo.com/App/323944/61533541/thumb.png?1540639645" alt="" data-v-437fdb74></div><span class="verified-icon" data-v-437fdb74><svg fill="currentColor" width="800" height="800" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" data-v-437fdb74><path d="M16 3C8.82 3 3 8.82 3 16s5.82 13 13 13 13-5.82 13-13S23.18 3 16 3zm7.258 9.307-9.486 9.485a.61.61 0 0 1-.861 0l-.191-.191-.001.001L7.5 16.346a.61.61 0 0 1 0-.862l1.294-1.293a.61.61 0 0 1 .862 0l3.689 3.716 7.756-7.756a.61.61 0 0 1 .862 0l1.294 1.294a.609.609 0 0 1 .001.862z" data-v-437fdb74></path></svg></span></span></div>', 1), ro = /* @__PURE__ */ F(() => /* @__PURE__ */ h("div", null, null, -1)), so = { class: "comment-main reply-content" };
function oo(e, t, r, n, s, o) {
  const i = Ae("StarsRate");
  return b(), w("div", vs, [
    h("div", bs, [
      h("span", ys, [
        h("span", ws, A(n.icon.toUpperCase()), 1),
        r.state ? (b(), w("span", Ss, Os)) : B("", !0)
      ]),
      h("div", As, [
        h("span", Ts, A(r.name), 1),
        h("div", xs, [
      ...
      h("div", Ls, [
        h("div", Is, [
          h("span", {
            ...
            Ms,
            h("span", Fs, A(n.shareLabel), 1)
          ]),
          T(en, null, {
            default: tn(() => [
              n.showMediaLink ? (b(), w("span", Us, [
                js,
                h("span", Bs, [
                  (b(!0), w(H, null, z(n.shareLinks.length, (a) => (b(), w("span", {
                    class: "list-item",
                    key: a
                  }, [
                    h("span", Hs, [
                      ...
                      }, A(n.shareLinks[a - 1].label), 9, zs),
                      a != n.shareLinks.length ? (b(), w("span", Gs)) : B("", !0)
                    ])
                  ]))), 128))
                ]),
                Vs
        ...
        h("div", $s, [
          h("div", qs, A(n.getFormatedDate(r.created_at)), 1),
          h("div", Ks, [
            h("div", {
              onClick: t[1] || (t[1] = (a) => n.actionLike(r.id)),
              class: "up-vote vote"
            }, Ws),
            h("span", Xs, A(r.likes), 1),
            h("div", {
              onClick: t[2] || (t[2] = (a) => n.actionDislike(r.id)),
              class: "down-vote vote"
            }, Ys),
            h("span", Zs, A(r.dislikes), 1)
          ])
        ])
      ])
    ]),
    r.reponse ? (b(), w("div", eo, [
      h("div", to, [
        no,
        h("div", null, [
          ro,
          h("div", so, A(r.reponse), 1)
        ])
      ])
    ])) : B("", !0)
  ]);
}
const io = /* @__PURE__ */ X(_s, [["render", oo], ["__scopeId", "data-v-437fdb74"]]), ao = {
  props: {
    currentPage: Number,
  ...
  setup(e, {
    ...
    const r = ie(), n = Math.ceil(r.state.commentsNumber / e.commentsPerPages), s = I(e.indexPrinted % 2 ? e.indexPrinted - 1 : e.indexPrinted), o = C(() => e.currentPage), i = C(() => {
      let c = 1, l = 0;
...
}, co = { class: "comments-navigation" }, lo = { class: "comments-indexes" }, uo = /* @__PURE__ */ h("svg", {
  width: "800",
  fill: "none",
  height: "800",
  viewBox: "0 0 48 48",
...
function go(e, t, r, n, s, o) {
  return b(), w("nav", co, [
    h("div", lo, [
      ...
      (b(!0), w(H, null, z(n.getIndexes.count, (i) => (b(), w("a", {
        key: i,
...
const _o = /* @__PURE__ */ X(ao, [["render", go]]), Wt = (e) => (dt("data-v-9913d917"), e = e(), ft(), e), vo = {
  class: "comments-widget"
}, bo = /* @__PURE__ */ Wt(() => /* @__PURE__ */ h("div", {
  class: "comments-header"
}, null, -1)), yo = /* @__PURE__ */ Wt(() => /* @__PURE__ */ h("div", {
  class: "clear-fix"
}, null, -1)), wo = {
  ...
  setup(e) {
    ...
    return (l, f) => (b(), w("div", vo, [bo, T(gs, {
      onApplyFilter: i,
      "rates-counts": ve(t).state.summary,
      "rate-selected": ve(t).state.rateSelected
    }, null, 8, ["rates-counts", "rate-selected"]), yo, ve(t).state.rateSelected ? (b(), w("div", {
      key: 0,
      onClick: f[0] || (f[0] = (g) => i(0)),
      class: "reset-comments"
    }, "Voir tous les avis")) : B("", !0), h("div", wo, [h("span", null, A(r.value), 1)]), h("div", So, [(b(!0), w(H, null, z(s.value, (g) => (b(), Te(io, $e({
      onLikeAction: u,
      onDislikeAction: c
    }, g, {
      key: g.id
...
const Oo = /* @__PURE__ */ X(Eo, [["__scopeId", "data-v-9913d917"]]), Ao = document.getElementById(Kt), To = Ao.getAttribute(ns);
Ge.commit("INIT_HANDLER", To);
