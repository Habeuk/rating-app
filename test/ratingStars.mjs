      ...
      if (a.endsWith(h, "{}"))
        ...
        return h = Fe(h), S.forEach(function(D, Ie) {
          !(a.isUndefined(D) || D === null) && t.append(
            ...
            i === !0 ? le([h], Ie, o) : i === null ? h : h + "[]",
            c(D)
          );
        }), !1;
    }
    return Q(f) ? !0 : (t.append(le(A, h, o), c(f)), !1);
  }
...
const Gt = typeof XMLHttpRequest < "u", Xt = Gt && function(e) {
  return new Promise(function(n, r) {
    ...
    }), a.isUndefined(e.withCredentials) || (c.withCredentials = !!e.withCredentials), i && i !== "json" && (c.responseType = e.responseType), typeof e.onDownloadProgress == "function" && c.addEventListener("progress", pe(e.onDownloadProgress, !0)), typeof e.onUploadProgress == "function" && c.upload && c.upload.addEventListener("progress", pe(e.onUploadProgress)), (e.cancelToken || e.signal) && (l = (y) => {
...
let be = 1;
an.forEach((e) => {
  const t = e.getAttribute("data-product-handler"), n = "/shopify/get-reviews.php?minify=1&product_handler=" + t;
  on.get(n).then((r) => {
    r.status == 200 && (console.log("product: " + t + " percentage: " + r.data.minify.mean), ie(Ee, {
      percentage: r.data.minify.mean,
      label: r.data.minify.count,
      id: be
    }).mount(e));
  }).catch((r) => {
    console.log("something went wrong: ", r), ie(Ee, {
      percentage: 0
    }).mount(e);
  }), be += 1;
});
